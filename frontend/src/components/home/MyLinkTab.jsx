        ...
        <div className="link-details-page">
            <div className="link-details-wrapper">
                <header className="link-header">
                    <a href={'http://localhost:5173/' + link.short_code} className="link-header__url" target="_blank" rel="noreferrer">
                ...
                <div className="stats-container">
                    <div className="stats-entry">
                        <span className="material-symbols-outlined stats-entry__icon">visibility</span>
                        <span className="stats-entry__label">Количество переходов:</span>
                        <span className="stats-entry__value">хх</span>
                    </div>
                    <div className="stats-entry">
                        <span className="material-symbols-outlined stats-entry__icon">ads_click</span>
                ...
                <footer className="link-footer-actions">
                    <button className="delete-action-btn" onClick={handleDelete} disabled={isLoading}>
