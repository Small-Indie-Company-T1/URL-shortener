...
const MOCK_LINKS = [
  { id: 1, short_code: 'qa2LmN', original_url: 'https://github.com/arina/project-tlink-very-long-url-example', created_at: '2026-04-28T12:00:00Z' },
  { id: 2, short_code: '3xKp9R', original_url: 'https://webstorm.com/work/setup', created_at: '2026-04-27T15:30:00Z' },
  { id: 3, short_code: 'dQw4w9', original_url: 'https://youtube.com/watch?v=dQw4w9WgXcQ', created_at: '2026-04-25T09:15:00Z' },
];
        ...
        <div className="links-container">
                ...
                {isLoading && linksList.length === 0 ? (
                    ...
                    linksList.map((link, index) => (
                        <div key={link.id} className="links-item">
                          <span className="links-item__index">{(currentPage - 1) * limit + index + 1}</span>
                          <span className="links-item__url">{link.original_url}</span>
                          <span className="links-item__date">
                      {link.created_at.substring(0, 10).split('-').reverse().join('.')}
                    </span>
                          <Link
          ...
          <div className="links-footer">
            <div className="links-stats-pill">
              ...
              <span className="stats-value">{currentPage}/{totalPages}</span>
            </div>
